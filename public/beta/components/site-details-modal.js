            ...
            ${details.libraries.map(lib => `
              <div class="detail-item" style="padding:var(--space-3);background:var(--color-bg-subtle);border-radius:6px;">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">
                  ...
                  <span class="badge" style="font-size:10px;background:${lib.versioning?.source === 'rest' || lib.versioning?.source === 'rest-title' ? 'var(--color-success)' : 'var(--color-border-subtle)'};color:white;padding:2px 6px;border-radius:3px;">${lib.versioning?.source || 'default'}</span>
                </div>
